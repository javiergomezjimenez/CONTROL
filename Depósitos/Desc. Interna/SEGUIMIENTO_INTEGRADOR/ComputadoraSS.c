...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetNumDiscStates(    S, 1);      /******* MODIFICADO *******/ /* Número de estados discretos: 0 */
...
static void mdlInitializeConditions(SimStruct *S)
{
 ...
 FLAG_INIT = 1;
     ...
     real_T *v0 = ssGetRealDiscStates(S);   /******* AÑADIDO *******/
    int_T  lp;                              /******* AÑADIDO *******/ 

    for (lp=0;lp<1;lp++) {                  /******* AÑADIDO *******/ 
        *v0++=0.0;                          /******* AÑADIDO *******/ 
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
 /***** NO MODIFICAR  ****/
  ...
  real_T            *v      = ssGetRealDiscStates(S);  /******* AÑADIDO *******/
