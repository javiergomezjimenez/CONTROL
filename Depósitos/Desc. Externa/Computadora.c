...
/* Entradas y estados */
#define     Yk            (*uPtrs0[0])   /* Entradas al sistema */
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (!ssSetNumInputPorts(S, 1)) return;      /* 1 puerto de entrada (Puertos: 0, 1) */
    ssSetInputPortWidth(S, 0, 1);               /* Dimensión del puerto de entrada 0: 1 entrada */
...
/*******************************************************/
//   #include "ControladorEscalón.c"
  #include "ControladorC2D.c"
//   #include "ControladorEULER1.c"
//   #include "ControladorEULER2.c"
//   #include "ControladorTUSTIN.c"
