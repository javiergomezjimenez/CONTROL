...
% Robot ??? (descomentar los que procedan)
  T1=F1z;       % Si es de traslación
  % T1=N1z;     % Si es de rotación
  % T2=F2z;     % Si es de traslación
  T2=N2z;       % Si es de rotación
  % T3=F3z;     % Si es de traslación
  T3=N3z;       % Si es de rotación
...
%% CÓDIGO PARA AÑADIR EL EFECTO DE LAS REDUCTORAS %
